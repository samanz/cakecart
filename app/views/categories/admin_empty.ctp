...
<div id = "addcategory">
   <p><?php echo $html->link('New Category', '/admin/categories/add/' . implode('/', $this->params['bread']), array('class'=>'button newCategory')); ?></p>
   <p class = "explain">If a category is added in this category, no products can be added to this category.</p>
</div>
<div id = "addproduct">
   <p><?php echo $html->link('New Product', '/admin/products/add/' . implode('/', $this->params['bread']), array('class'=>'button newProduct')); ?></p>
